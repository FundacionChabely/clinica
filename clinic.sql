...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-04-2022 a las 04:27:46
...
--
-- Estructura Stand-in para la vista `action_serial`
...
--
-- Estructura de tabla para la tabla `appointment_tbl`
--
...
--
-- Volcado de datos para la tabla `appointment_tbl`
--
...
--
-- Estructura de tabla para la tabla `app_setting`
--
...
--
-- Volcado de datos para la tabla `app_setting`
--
...
INSERT INTO `ci_sessions` (`id`, `ip_address`, `timestamp`, `data`, `date`) VALUES
('17n0d80m0akg34fetnrsqa95ievhifnq', '::1', 1649038083, , '0000-00-00'),
('agkdsll4mnqefdgij01hdac7kjmk1l39', '::1', 1648082715, , '0000-00-00'),
('qc4hb3ib10ilhgqnv3ifcppcmf900abf', '::1', 1648082678, , '0000-00-00');
...
--
-- Volcado de datos para la tabla `custom_sms_info`
--
...
--
-- Estructura de tabla para la tabla `doctor_details`
--
...
--
-- Estructura de tabla para la tabla `doctor_tbl`
--
...
--
-- Volcado de datos para la tabla `doctor_tbl`
--
...
(7, 16, 'chava', '', '', '', '', '', '0000-00-00', 'Male', '', '4271451427', '                                        ', '', '                                        ', '', 1);
...
--
-- Estructura de tabla para la tabla `email_delivery`
--
...
--
-- Volcado de datos para la tabla `email_delivery`
--
...
--
-- Estructura de tabla para la tabla `email_schedule`
--
...
--
-- Estructura de tabla para la tabla `emergency_stop_tbl`
--
...
--
-- Estructura de tabla para la tabla `herbs`
--
...
--
-- Volcado de datos para la tabla `herbs`
--
...
--
-- Estructura de tabla para la tabla `log_info`
--
...
--
-- Volcado de datos para la tabla `log_info`
--
...
(16, 'chava@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 2, 1, '');
...
--
-- Estructura de tabla para la tabla `medicine_herbs`
--
...
--
-- Volcado de datos para la tabla `medicine_herbs`
--
...
--
-- Estructura de tabla para la tabla `medicine_temp`
--
...
--
-- Estructura de tabla para la tabla `patient_medical_info`
--
...
--
-- Volcado de datos para la tabla `patient_medical_info`
--
...
--
-- Estructura de tabla para la tabla `patient_tbl`
--
...
--
-- Volcado de datos para la tabla `patient_tbl`
--
...
--
-- Estructura de tabla para la tabla `payment_account_setup`
--
...
--
-- Volcado de datos para la tabla `payment_account_setup`
--
...
--
-- Estructura de tabla para la tabla `prescription_data`
--
...
--
-- Volcado de datos para la tabla `prescription_data`
--
...
--
-- Estructura de tabla para la tabla `pres_language`
--
...
--
-- Volcado de datos para la tabla `pres_language`
--
...
--
-- Estructura de tabla para la tabla `print_pattern`
--
...
--
-- Volcado de datos para la tabla `print_pattern`
--
...
--
-- Estructura de tabla para la tabla `schedul_setup_tbl`
--
...
--
-- Volcado de datos para la tabla `schedul_setup_tbl`
--
...
--
-- Estructura de tabla para la tabla `service_info`
--
...
--
-- Volcado de datos para la tabla `service_info`
--
...
--
-- Volcado de datos para la tabla `sms_info`
--
...
--
-- Estructura de tabla para la tabla `web_pages_tbl`
--
...
--
-- Volcado de datos para la tabla `web_pages_tbl`
--
...
--
-- Estructura para la vista `action_serial`
--
...
--
-- Indices de la tabla `appointment_tbl`
--
ALTER TABLE `appointment_tbl`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `app_setting`
--
...
--
-- Indices de la tabla `doctor_details`
--
ALTER TABLE `doctor_details`
  ADD PRIMARY KEY (`doctor_details_id`);

--
-- Indices de la tabla `doctor_tbl`
--
...
--
-- Indices de la tabla `email_delivery`
--
...
--
-- Indices de la tabla `email_schedule`
--
...
--
-- Indices de la tabla `emergency_stop_tbl`
--
ALTER TABLE `emergency_stop_tbl`
  ADD PRIMARY KEY (`stop_id`);

--
-- Indices de la tabla `herbs`
--
ALTER TABLE `herbs`
...
--
-- Indices de la tabla `medicine_herbs`
--
ALTER TABLE `medicine_herbs`
  ADD PRIMARY KEY (`mh_id`);

--
-- Indices de la tabla `medicine_temp`
--
ALTER TABLE `medicine_temp`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `patient_medical_info`
--
ALTER TABLE `patient_medical_info`
  ADD PRIMARY KEY (`pmi_id`);

--
-- Indices de la tabla `patient_tbl`
--
ALTER TABLE `patient_tbl`
  ADD PRIMARY KEY (`patient_id`);

--
-- Indices de la tabla `payment_account_setup`
--
...
--
-- Indices de la tabla `prescription_data`
--
ALTER TABLE `prescription_data`
  ADD PRIMARY KEY (`prescription_id`);

--
-- Indices de la tabla `pres_language`
--
ALTER TABLE `pres_language`
  ADD PRIMARY KEY (`lang_id`);

--
-- Indices de la tabla `print_pattern`
--
ALTER TABLE `print_pattern`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `schedul_setup_tbl`
--
...
--
-- Indices de la tabla `service_info`
--
...
--
-- Indices de la tabla `web_pages_tbl`
--
...
--
-- AUTO_INCREMENT de la tabla `appointment_tbl`
--
ALTER TABLE `appointment_tbl`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `app_setting`
--
ALTER TABLE `app_setting`
...
--
-- AUTO_INCREMENT de la tabla `doctor_details`
--
ALTER TABLE `doctor_details`
  MODIFY `doctor_details_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `doctor_tbl`
--
ALTER TABLE `doctor_tbl`
  MODIFY `doctor_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT de la tabla `email_delivery`
--
ALTER TABLE `email_delivery`
...
--
-- AUTO_INCREMENT de la tabla `email_schedule`
--
ALTER TABLE `email_schedule`
...
--
-- AUTO_INCREMENT de la tabla `emergency_stop_tbl`
--
ALTER TABLE `emergency_stop_tbl`
  MODIFY `stop_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `herbs`
--
ALTER TABLE `herbs`
...
--
-- AUTO_INCREMENT de la tabla `log_info`
--
ALTER TABLE `log_info`
...
--
-- AUTO_INCREMENT de la tabla `medicine_herbs`
--
ALTER TABLE `medicine_herbs`
  MODIFY `mh_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `medicine_temp`
--
ALTER TABLE `medicine_temp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `patient_medical_info`
--
ALTER TABLE `patient_medical_info`
  MODIFY `pmi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `payment_account_setup`
--
ALTER TABLE `payment_account_setup`
...
--
-- AUTO_INCREMENT de la tabla `prescription_data`
--
ALTER TABLE `prescription_data`
  MODIFY `prescription_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `pres_language`
--
ALTER TABLE `pres_language`
  MODIFY `lang_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `print_pattern`
--
ALTER TABLE `print_pattern`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `schedul_setup_tbl`
--
ALTER TABLE `schedul_setup_tbl`
...
--
-- AUTO_INCREMENT de la tabla `service_info`
--
ALTER TABLE `service_info`
...
--
-- AUTO_INCREMENT de la tabla `web_pages_tbl`
--
ALTER TABLE `web_pages_tbl`
